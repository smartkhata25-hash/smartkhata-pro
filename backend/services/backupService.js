...
const COLLECTION_CONFIG = {
  ...
  employeedesignations: { field: "userId", required: false },
  employees: { field: "userId", required: false },
  employeepayrolls: { field: "userId", required: false },
  employeeadvanceloans: { field: "userId", required: false },
  ...
  weavingunits: { field: "userId", required: false },
  weavingdepartments: { field: "userId", required: false },
  weavingshifts: { field: "userId", required: false },
  weavingattendances: { field: "userId", required: false },
  weavinggodowns: { field: "userId", required: false },
  weavingyarns: { field: "userId", required: false },
  weavingfabricqualities: { field: "userId", required: false },
  weavinglooms: { field: "userId", required: false },
  weavingmasteroptions: { field: "userId", required: false },
  weavingstocktransactions: { field: "userId", required: false },
  weavingcontracts: { field: "userId", required: false },
  weavingparties: { field: "userId", required: false },
  weavingitems: { field: "userId", required: false },
  weavingyarnmovements: { field: "userId", required: false },
  weavingstockadjustments: { field: "userId", required: false },
  weavingfoldingentries: { field: "userId", required: false },
  weavingkacchiparchis: { field: "userId", required: false },
  weavingpakkisettlements: { field: "userId", required: false },
  weavingsalesinvoices: { field: "userId", required: false },
  weavingfabricmovements: { field: "userId", required: false },
  weavingrejectiondues: { field: "userId", required: false },
  weavingrejectionreceipts: { field: "userId", required: false },
  weavingpurchaseinvoices: { field: "userId", required: false },
  weavingmoneytransactions: { field: "userId", required: false },
  weavingsizingissues: { field: "userId", required: false },
  weavingsizingreceipts: { field: "userId", required: false },
  weavingsizingbills: { field: "userId", required: false },
