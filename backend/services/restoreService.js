...
const MODEL_LOADERS = {
  ...
  weavingunits: () => require("../models/WeavingUnit"),
  weavingdepartments: () => require("../models/WeavingDepartment"),
  weavingshifts: () => require("../models/WeavingShift"),
  weavingattendances: () => require("../models/WeavingAttendance"),
  weavinggodowns: () => require("../models/WeavingGodown"),
  weavingyarns: () => require("../models/WeavingYarn"),
  weavingfabricqualities: () => require("../models/WeavingFabricQuality"),
  weavinglooms: () => require("../models/WeavingLoom"),
  weavingmasteroptions: () => require("../models/WeavingMasterOption"),
  weavingstocktransactions: () => require("../models/WeavingStockTransaction"),
  weavingcontracts: () => require("../models/WeavingContract"),
  weavingparties: () => require("../models/WeavingParty"),
  weavingitems: () => require("../models/WeavingItem"),
  weavingyarnmovements: () => require("../models/WeavingYarnMovement"),
  weavingstockadjustments: () => require("../models/WeavingStockAdjustment"),
  weavingfoldingentries: () => require("../models/WeavingFoldingEntry"),
  weavingkacchiparchis: () => require("../models/WeavingKacchiParchi"),
  weavingpakkisettlements: () => require("../models/WeavingPakkiSettlement"),
  weavingsalesinvoices: () => require("../models/WeavingSalesInvoice"),
  weavingfabricmovements: () => require("../models/WeavingFabricMovement"),
  weavingrejectiondues: () => require("../models/WeavingRejectionDue"),
  weavingrejectionreceipts: () => require("../models/WeavingRejectionReceipt"),
  weavingpurchaseinvoices: () => require("../models/WeavingPurchaseInvoice"),
  weavingmoneytransactions: () => require("../models/WeavingMoneyTransaction"),
  weavingsizingissues: () => require("../models/WeavingSizingIssue"),
  weavingsizingreceipts: () => require("../models/WeavingSizingReceipt"),
  weavingsizingbills: () => require("../models/WeavingSizingBill"),
